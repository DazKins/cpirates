...
void DebugRender_obb(OBB obb) {
  ...
  // Assuming obb.axis[0] is right, obb.axis[1] is up, and obb.axis[2] is
  // forward:
  V right = obb.axis[0];
  V up = obb.axis[1];
  ...
  float line_vertices[] = {
      // Bottom face edges
      v0.x, v0.y, v0.z, v1.x, v1.y, v1.z, v1.x, v1.y, v1.z, v2.x, v2.y, v2.z,
      v2.x, v2.y, v2.z, v3.x, v3.y, v3.z, v3.x, v3.y, v3.z, v0.x, v0.y, v0.z,

      // Top face edges
      v4.x, v4.y, v4.z, v5.x, v5.y, v5.z, v5.x, v5.y, v5.z, v6.x, v6.y, v6.z,
      v6.x, v6.y, v6.z, v7.x, v7.y, v7.z, v7.x, v7.y, v7.z, v4.x, v4.y, v4.z,

      // Vertical edges connecting bottom and top faces
      v0.x, v0.y, v0.z, v4.x, v4.y, v4.z, v1.x, v1.y, v1.z, v5.x, v5.y, v5.z,
      v2.x, v2.y, v2.z, v6.x, v6.y, v6.z, v3.x, v3.y, v3.z, v7.x, v7.y, v7.z};
